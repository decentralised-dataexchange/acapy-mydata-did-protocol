...
class MyDataDIDRegistryTransaction(BaseExchangeRecord):
    class Meta:
        schema_class = "MyDataDIDRegistryTransactionSchema"
...
class MyDataDIDRegistryTransactionSchema(BaseExchangeSchema):

    class Meta:

        model_class = MyDataDIDRegistryTransaction
    ...
    state = fields.Str(
        ...
        example=MyDataDIDRegistryTransaction.STATE_SUCCESS,
    )
    ...
    record_type = fields.Str(
        ...
        example=MyDataDIDRegistryTransaction.RECORD_TYPE_CREATE,
    )
