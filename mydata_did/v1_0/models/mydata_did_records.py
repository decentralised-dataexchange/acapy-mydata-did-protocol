...
class V10MyDataDIDRecord(BaseExchangeRecord):
    class Meta:
        schema_class = "V10MyDataDIDRecordSchema"
...
class V10MyDataDIDRecordSchema(BaseExchangeSchema):

    class Meta:

        model_class = V10MyDataDIDRecord
    ...
    state = fields.Str(
        ...
        example=V10MyDataDIDRecord.STATE_DID_VERIFIED,
    )
